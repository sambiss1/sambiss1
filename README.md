...
<a>[![My Skills](https://skillicons.dev/icons?i=html,css,sass,bootstrap, materialui,js,ts,git,github,react,nextjs,redux,nodejs,express,mongodb,mysql,nestjs,heroku,figma,wordpress)](https://skillicons.dev)</a>
